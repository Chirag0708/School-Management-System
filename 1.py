...
con = a.connect(host="localhost",user="root",passwd="Chir@g06Sh@rm@",database="School")
...
def rst():
    ...
    r=input("Roll No:")
    data=(c,r)
    sql='delete from student where CLASS = %S and ROW = %s'
    c = con.cursor()
    c.execute(sql,data)
    con.commit()
    print("Data Updated")
...
def main():
    print("""                  TRANSLAM ACADEMY INTERNATIONAL
               1. ADD STUDENT   2. REMOVE STUDENT   3. ADD TEACHER
               4. REMOVE TEACHER   5.CLASS ATTENDANCE   6. TEACHER ATTENDANCE
               7. SUBMIT FEES     8. PAY SALARY    9. DISPLAY CLASS
               10. TEACHER LIST
""")
